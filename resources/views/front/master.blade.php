...
<head>
  ...
  <!-- Css -->
  <link rel="stylesheet" href="{{ asset('/') }}frontend-2/css/bootstrap.min.css" />
  <link rel="stylesheet" href="{{ asset('/') }}frontend-2/css/magnific-popup.css" />
  <link rel="stylesheet" href="{{ asset('/') }}frontend-2/css/font-icons.css" />
  <link rel="stylesheet" href="{{ asset('/') }}frontend-2/css/sliders.css" />
  <link rel="stylesheet" href="{{ asset('/') }}frontend-2/css/style.css" />

  <!-- Favicons -->
  <link rel="shortcut icon" href="{{ asset('/') }}frontend-2/img/favicon.ico">
  <link rel="apple-touch-icon" href="{{ asset('/') }}frontend-2/img/apple-touch-icon.png">
  <link rel="apple-touch-icon" sizes="72x72" href="{{ asset('/') }}frontend-2/img/apple-touch-icon-72x72.png">
  <link rel="apple-touch-icon" sizes="114x114" href="{{ asset('/') }}frontend-2/img/apple-touch-icon-114x114.png">
...
<body class="relative">
            ...
            <div class="row flex-parent">
              ...
              <div class="navbar-header flex-child">
                ...
                <div class="logo-container">
                  <div class="logo-wrap">
                    <a href="{{ route('/') }}">
                      <img class="logo-dark" src="{{ asset('/') }}frontend-2/img/logo_dark.png" alt="logo">
                    </a>
                  </div>
                </div>
    ...
    <div class="content-wrapper oh">
      ...
      {{-- <section class="hero-wrap text-center relative">
        <div id="owl-hero" class="owl-carousel owl-theme light-arrows slider-animated">
          <div class="hero-slide overlay" style="background-image:url({{ asset('/') }}frontend-2/img/hero/1.jpg)">
            <div class="container">
          ...
          <div class="hero-slide overlay" style="background-image:url({{ asset('/') }}frontend-2/img/hero/2.jpg)">
            <div class="container">
              <div class="hero-holder">
                <div class="hero-message">
          ...
          <div class="hero-slide overlay" style="background-image:url({{ asset('/') }}frontend-2/img/hero/3.jpg)">
            <div class="container">
              <div class="hero-holder">
                <div class="hero-message">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-xs-4 col-xxs-12 mb-30 promo-banner">
              <a href="#">
                <img src="{{ asset('/') }}frontend-2/img/shop/collection_1.jpg" alt="">
            ...
            <div class="col-xs-4 col-xxs-12 mb-30 promo-banner">
              <a href="#">
                <img src="{{ asset('/') }}frontend-2/img/shop/collection_2.jpg" alt="">
                <div class="overlay"></div>
                <div class="promo-inner valign">
                  <h2>accessories</h2>
            ...
            <div class="col-xs-4 col-xxs-12 mb-30 promo-banner">
              <a href="#">
                <img src="{{ asset('/') }}frontend-2/img/shop/collection_3.jpg" alt="">
                <div class="overlay"></div>
                <div class="promo-inner valign">
                  <h2>for him</h2>
      ...
      <!-- Testimonials -->
      {{-- <section class="section-wrap relative testimonials bg-parallax overlay" style="background-image:url({{ asset('/') }}frontend-2/img/testimonials/testimonial_bg.jpg);">
        <div class="container relative">
  ...
  <!-- jQuery Scripts -->
  <script type="text/javascript" src="{{ asset('/') }}frontend-2/js/jquery.min.js"></script>
  <script type="text/javascript" src="{{ asset('/') }}frontend-2/js/bootstrap.min.js"></script>
  <script type="text/javascript" src="{{ asset('/') }}frontend-2/js/plugins.js"></script>  
  <script type="text/javascript" src="{{ asset('/') }}frontend-2/js/scripts.js"></script>
