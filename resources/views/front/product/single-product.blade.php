      ...
      <div class="row">
        ...
        <div class="col-md-6 col-xs-12 product-slider mb-60">
          ...
          <div class="flickity flickity-slider-wrap mfp-hover" id="gallery-main">
            ...
            <div class="gallery-cell">
              <a href="{{ asset('/') }}frontend/images/shop/item_lg_2.jpg" class="lightbox-img">
                <img src="{{ asset('/') }}frontend/images/shop/item_lg_2.jpg" alt="" />
                <i class="ui-zoom zoom-icon"></i>
              </a>
            </div>
            <div class="gallery-cell">
              <a href="{{ asset('/') }}frontend/images/shop/item_lg_3.jpg" class="lightbox-img">
                <img src="{{ asset('/') }}frontend/images/shop/item_lg_3.jpg" alt="" />
                <i class="ui-zoom zoom-icon"></i>
              </a>
            </div>
            <div class="gallery-cell">
              <a href="{{ asset('/') }}frontend/images/shop/item_lg_4.jpg" class="lightbox-img">
                <img src="{{ asset('/') }}frontend/images/shop/item_lg_4.jpg" alt="" />
                <i class="ui-zoom zoom-icon"></i>
              </a>
            </div>
            <div class="gallery-cell">
              <a href="{{ asset('/') }}frontend/images/shop/item_lg_5.jpg" class="lightbox-img">
                <img src="{{ asset('/') }}frontend/images/shop/item_lg_5.jpg" alt="" />
                <i class="ui-zoom zoom-icon"></i>
              </a>
            </div>
          </div> 
          ...
          <div class="gallery-thumbs">
            <div class="gallery-cell">
              <img src="{{ asset('/') }}frontend/images/shop/item_thumb_1.jpg" alt="" />
            </div>
            <div class="gallery-cell">
              <img src="{{ asset('/') }}frontend/images/shop/item_thumb_2.jpg" alt="" />
            </div>
            <div class="gallery-cell">
              <img src="{{ asset('/') }}frontend/images/shop/item_thumb_3.jpg" alt="" />
            </div>
            <div class="gallery-cell">
              <img src="{{ asset('/') }}frontend/images/shop/item_thumb_4.jpg" alt="" />
            </div>
            <div class="gallery-cell">
              <img src="{{ asset('/') }}frontend/images/shop/item_thumb_5.jpg" alt="" />
            </div>
            ...
            <div class="product-item hover-trigger">
              <div class="product-img">
                <a href="shop-single.html">
                  ...
                  <img src="{{ asset('/') }}frontend/images/shop/shop_item_back_3.jpg" alt="" class="back-img">
                </a>
            ...
            <div class="product-item hover-trigger">
              <div class="product-img">
                <a href="shop-single.html">
                  ...
                  <img src="{{ asset('/') }}frontend/images/shop/shop_item_back_11.jpg" alt="" class="back-img">
                </a>
                <div class="hover-2">                    
                  <div class="product-actions">
                    <a href="#" class="product-add-to-wishlist">
            ...
            <div class="product-item hover-trigger">
              <div class="product-img">
                <a href="shop-single.html">
                  ...
                  <img src="{{ asset('/') }}frontend/images/shop/shop_item_back_6.jpg" alt="" class="back-img">
                </a>
                <div class="hover-2">                    
                  <div class="product-actions">
                    <a href="#" class="product-add-to-wishlist">
            ...
            <div class="product-item hover-trigger">
              <div class="product-img">
                <a href="shop-single.html">
                  ...
                  <img src="{{ asset('/') }}frontend/images/shop/shop_item_back_4.jpg" alt="" class="back-img">
                </a>
                <div class="hover-2">                    
                  <div class="product-actions">
                    <a href="#" class="product-add-to-wishlist">
            ...
            <div class="product-item hover-trigger">
              <div class="product-img">
                <a href="shop-single.html">
                  ...
                  <img src="{{ asset('/') }}frontend/images/shop/shop_item_back_5.jpg" alt="" class="back-img">
                </a>
                <div class="hover-2">                    
                  <div class="product-actions">
                    <a href="#" class="product-add-to-wishlist">
