          ...
          <div class="row">
            ...
            <div class="col-md-6 col-xs-12 product-slider mb-60">
              ...
              <div class="flickity flickity-slider-wrap mfp-hover" id="gallery-main">
                ...
                <div class="gallery-cell">
                  <a href="img/shop/item_lg_1.jpg" class="lightbox-img">
                    <img src="{{ asset('/') }}frontend-2/img/shop/item_lg_1.jpg" alt="" />
                    <i class="ui-zoom zoom-icon"></i>
                  </a>
                </div>
                <div class="gallery-cell">
                  <a href="img/shop/item_lg_2.jpg" class="lightbox-img">
                    <img src="{{ asset('/') }}frontend-2/img/shop/item_lg_2.jpg" alt="" />
                    <i class="ui-zoom zoom-icon"></i>
                  </a>
                </div>
                <div class="gallery-cell">
                  <a href="img/shop/item_lg_3.jpg" class="lightbox-img">
                    <img src="{{ asset('/') }}frontend-2/img/shop/item_lg_3.jpg" alt="" />
                    <i class="ui-zoom zoom-icon"></i>
                  </a>
                </div>
                <div class="gallery-cell">
                  <a href="img/shop/item_lg_4.jpg" class="lightbox-img">
                    <img src="{{ asset('/') }}frontend-2/img/shop/item_lg_4.jpg" alt="" />
                    <i class="ui-zoom zoom-icon"></i>
                  </a>
                </div>
                <div class="gallery-cell">
                  <a href="img/shop/item_lg_5.jpg" class="lightbox-img">
                    <img src="{{ asset('/') }}frontend-2/img/shop/item_lg_5.jpg" alt="" />
                    <i class="ui-zoom zoom-icon"></i>
                  </a>
                </div>
              ...
              <div class="gallery-thumbs">
                <div class="gallery-cell">
                  <img src="{{ asset('/') }}frontend-2/img/shop/item_thumb_1.jpg" alt="" />
                </div>
                <div class="gallery-cell">
                  <img src="{{ asset('/') }}frontend-2/img/shop/item_thumb_2.jpg" alt="" />
                </div>
                <div class="gallery-cell">
                  <img src="{{ asset('/') }}frontend-2/img/shop/item_thumb_3.jpg" alt="" />
                </div>
                <div class="gallery-cell">
                  <img src="{{ asset('/') }}frontend-2/img/shop/item_thumb_4.jpg" alt="" />
                </div>
                <div class="gallery-cell">
                  <img src="{{ asset('/') }}frontend-2/img/shop/item_thumb_5.jpg" alt="" />
                </div>
