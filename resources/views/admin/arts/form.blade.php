                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <label class="checkbox-inline" for="digital">
                                    <input type="checkbox"
                                    @if(isset($art)){{$art->digital==1?"checked":""}} @endif id="digital" name="digital" value="1"> Digital
                                </label>
                                <label class="checkbox-inline" for="physical">
                                    <input type="checkbox" @if(isset($art)){{$art->physical==1?"checked":""}} @endif  id="physical" name="physical" value="1"> Physical
                                </label>
                        ...
                        <div class="form-group physical">
                            ...
                            <div class="col-md-7">
                                <textarea id="physical_instructions" name="physical_instructions" rows="9"
                                    class="form-control" placeholder="Instructions for physical.." > {{ $art->physical_instructions ?? ''}} </textarea>
                            </div>
                        </div>
