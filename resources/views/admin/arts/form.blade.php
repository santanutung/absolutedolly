            ...
            <div class="col-xs-12">
                <form id="form-validation" class="form-horizontal form-bordered" method="post"
                    ...
                    <fieldset>
                                            ...
                                            @foreach ($extra_images as $extra_image)
                                                <div class="col-md-4">
                                                    <input type="file" id="extra_images" name="extra_images[]"
                                                        ...
                                                        data-default-file="{{ asset('extra_image/art/' . $extra_image) }}">
                                                </div>
                                            @endforeach
                                        </div>
                                        @error('extra_images')
                       ...
                       @else
                       <div class="form-group  create  @error('extra_images') has-error @enderror" value="{{ $art->extra_images ?? '' }}">
                            <label class="col-md-3 control-label" for="extra_images">Extra Images <span
                                    class="text-danger">*</span></label>
                            <div class="col-md-7">
                                <div class="row">
                                    <div class="col-md-4">
                                         <input type="file" id="extra_images" name="extra_images[]" class="form-control dropify" data-default-file="">
                                    </div>
                                     <div class="col-md-4">
                                         <input type="file" id="extra_images" name="extra_images[]" class="form-control dropify" data-default-file="">
                                    </div>
                        ...
                        <div class="form-group   @error('item_id') has-error @enderror"
                            value="{{ $art->item_id ?? '' }}">
                        ...
                        <div class="form-group digital   @error('digital_art_price') has-error @enderror"
                            ...
                            <div class="col-md-5">
                                ...
                                <input type="number" id="digital_art_price" name="digital_art_price"
                                    class="form-control digital_art" placeholder="Enter amount.."
                                    value="{{ $art->digital_art_price ?? '' }}">
                        ...
                        <div class="form-group digital   @error('digital_art_dis') has-error @enderror"
                            ...
                            <div class="col-md-5">
                                ...
                                <input type="number" id="digital_art_dis" name="digital_art_dis"
                                    class="form-control digital_art" placeholder="Enter amount.."
                                    value="{{ $art->digital_art_dis ?? '' }}">
                        ...
                        <div class="form-group digital    @error('digital_art_sell') has-error @enderror"
                            ...
                            <label class="col-md-3 control-label" for="digital_art_sell">Selling Price:- <span
                                    class="text-danger">*</span></label>
                            <div class="col-md-5">
                                <input type="number" readonly id="digital_art_sell" name="digital_art_sell"
                        ...
                        <div class="form-group physical  @error('physical_art_price') has-error @enderror"
                            ...
                            <div class="col-md-5">
                                ...
                                <input type="number" id="physical_art_price" name="physical_art_price"
                                    class="form-control physical_art" placeholder="Enter amount.."
                                    value="{{ $art->physical_art_price ?? '' }}">
                        ...
                        <div class="form-group physical  @error('physical_art_dis') has-error @enderror"
                            ...
                            <div class="col-md-5">
                                ...
                                <input type="number" id="physical_art_dis" name="physical_art_dis"
                                    class="form-control physical_art" placeholder="Enter amount.."
                                    value="{{ $art->physical_art_dis ?? '' }}">
                        ...
                        <div class="form-group physical  @error('physical_art_sell') has-error @enderror"
                            ...
                            <div class="col-md-5">
                                ...
                                <input type="number" readonly id="physical_art_sell" name="physical_art_sell"
                                    class="form-control " placeholder="Enter amount.."
                                    value="{{ $art->physical_art_sell ?? '' }}">
                        ...
                        <div class="form-group physical  @error('materia_used_painting') has-error @enderror"
                            ...
                            <div class="col-md-5">
                                ...
                                <input type="text" id="materia_used_painting" name="materia_used_painting"
